...
ActiveRecord::Schema.define(version: 20170731085838) do
  ...
  create_table "bills", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["jobcard_id"], name: "index_bills_on_jobcard_id"
  end
  ...
  create_table "stocks", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.text "paper_from"
    t.string "paper_type"
    t.integer "quantity"
    t.integer "size"
